...
namespace CQSS.Pay.BLL.Alipay
{
    ...
    public class AlipayConfig
    {
        ...
        public static string partner = AppConfig.AlipayPartner;

        // 收款支付宝账号，以2088开头由16位纯数字组成的字符串，一般情况下收款账号就是签约账号
        public static string seller_id = partner;

        // 卖家支付宝账号 seller_email是支付宝登录账号，格式一般是邮箱或手机号
        public static string seller_email = AppConfig.AlipaySellerEmail;

        // MD5密钥，安全检验码，由数字和字母组成的32位字符串，查看地址：https://b.alipay.com/order/pidAndKey.htm
        public static string key = AppConfig.AlipayKey;
