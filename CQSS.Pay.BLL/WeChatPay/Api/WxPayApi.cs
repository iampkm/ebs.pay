...
namespace CQSS.Pay.BLL.WeChatPay.Api
{
    public class WxPayApi
    {
        ...
        */
        public static WxPayData Micropay(WxPayData inputObj, int timeOut = 30)
        {
            ...
            inputObj.SetValue("spbill_create_ip", System.Web.HttpContext.Current.Request.UserHostAddress);//终端ip
        ...
        */
        public static WxPayData Reverse(WxPayData inputObj, int timeOut = 15)
        {
        ...
        */
        public static WxPayData Report(WxPayData inputObj, int timeOut = 1)
        {
            ...
            inputObj.SetValue("appid", WxPayConfig.APPID);//公众账号ID
            inputObj.SetValue("mch_id", WxPayConfig.MCHID);//商户号
            inputObj.SetValue("user_ip", System.Web.HttpContext.Current.Request.UserHostAddress);//终端ip
