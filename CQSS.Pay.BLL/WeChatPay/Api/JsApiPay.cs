...
namespace CQSS.Pay.BLL.WeChatPay.Api
{
    public class JsApiPay
    {
        ...
        */
        public void GetOpenidAndAccessToken()
        {
            ...
            else
            {
                ...
                string redirect_uri = HttpUtility.UrlEncode("http://" + host + rawUrl);
        ...
        */
        public void GetOpenidAndAccessTokenFromCode(string code)
        {
            try
            {
                ...
                access_token = JsonHelper.GetJsonNode(result, "access_token");

                //获取用户openid
                openid = JsonHelper.GetJsonNode(result, "openid");
        ...
        * @失败时抛异常WxPayException
        */
        public WxPayData GetUnifiedOrderResult(string out_trade_no, int total_fee, string notify_url, string time_expire)
        {
            //统一下单
            WxPayData data = new WxPayData();
            ...
            //data.SetValue("goods_tag", "SJG365");
